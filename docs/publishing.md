...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190131-lights">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190131-lights/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190131-lights/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190131-lights/",
      "url": "http://static.startribune.com/news/projects/all/20190131-lights/"
    }
  }
}
```
